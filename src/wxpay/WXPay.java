...
import wxpay.business.DownloadBillBusiness;
import wxpay.business.RefundBusiness;
import wxpay.business.RefundQueryBusiness;
import wxpay.business.ScanPayBusiness;
import wxpay.common.Configure;
import wxpay.protocol.downloadbill_protocol.DownloadBillReqData;
import wxpay.protocol.pay_protocol.ScanPayReqData;
import wxpay.protocol.pay_query_protocol.ScanPayQueryReqData;
import wxpay.protocol.refund_protocol.RefundReqData;
import wxpay.protocol.refund_query_protocol.RefundQueryReqData;
import wxpay.protocol.reverse_protocol.ReverseReqData;
import wxpay.service.DownloadBillService;
import wxpay.service.RefundQueryService;
import wxpay.service.RefundService;
import wxpay.service.ReverseService;
import wxpay.service.ScanPayQueryService;
import wxpay.service.ScanPayService;
...
public class WXPay {
    ...
    public static void initSDKConfiguration(String key,String appID,String mchID,String sdbMchID,String certLocalPath,String certPassword){
        ...
        Configure.setIp(NetUtil.getIP());
        
        Configure.isEnable = true;
    }
